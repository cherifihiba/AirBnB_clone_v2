...
class test_basemodel(unittest.TestCase):
    ...
    def test_updated_at(self):
        ...
        n = nw.to_dict()
        nw = BaseModel(**n)
        self.assertFalse(new.created_at == nw.updated_at)
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_init_BaseModel(self):
        """Base testd if is an type BaseModel"""
    ...
    def test_to_dict_BaseModel(self):
        ...
        self.assertIsInstance(basDict['created_at'], str)
        self.assertIsInstance(basDict['updated_at'], str)
